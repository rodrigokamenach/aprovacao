...
<div class="col-md-5">
    <div class="panel panel-custom">
        <div class="panel-heading">
            <h5><i class="fas fa-chart-area"></i> Resumo por Conta Financeira do Período(Mês Fechado)</h5>
        </div>
        <div class="panel-body">
            <div id="pivotcta"  style="height: 350px; width: 100%;"></div>
        </div>
    </div>
</div>
<?php
